...
const galleryData = [
  ...
  { id: 3,  label: 'Dyed Wool Drying, Kathmandu',           category: 'Operations',  height: 280, bg: '#3A4A5A', image: '/images/gallery/dyed-wool-drying.webp' },
  ...
  { id: 7,  label: 'Sheep Shearing, New Zealand',           category: 'Sourcing',    height: 260, bg: '#6A3A2A', image: '/images/gallery/sheep-shearing.jpg' },
  ...
  { id: 10, label: 'Industrial Dyeing Operations',         category: 'Operations',  height: 280, bg: '#4A2A1A', image: '/images/gallery/dyeing-operations.jpg' },
  { id: 11, label: 'Founding Partners, Humble Beginnings',  category: 'Operations',  height: 240, bg: '#5A4535', image: '/images/gallery/founding-partners.jpg' },
